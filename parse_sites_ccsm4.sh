...
in_dir=/projectnb/dietzelab/paleon/met_regional/ccsm4/
out_dir=/projectnb/dietzelab/paleon/met_regional/ccsm4/sites/

vars=(precipf psurf qair swdown tair wind)
